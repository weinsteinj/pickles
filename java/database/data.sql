...
INSERT INTO pets(name, species, sex, birth_date, is_fixed, has_vaccinations, size, pet_photo)
VALUES ('James Franco', 'Dog', 'male', '2013-08-15', true, true, 3, 'https://res.cloudinary.com/picklepoints/image/upload/v1660761411/ii8qmangutleyjrzlu9l.jpg');

INSERT INTO pets(name, species, sex, birth_date, is_fixed, has_vaccinations, size, pet_photo)
VALUES ('Flop', 'Cat', 'male', '2020-01-01', true, true, 1, 'https://res.cloudinary.com/picklepoints/image/upload/v1660761411/rcseu1kf6uvvx02ur0t7.jpg');
...
INSERT INTO playdate (host_id, zip_code, date_and_time, details, playdate_photo) VALUES (1, '15202', '2022-09-30T12:00:00', 'Go on a walk with us!', 'https://res.cloudinary.com/picklepoints/image/upload/v1660694414/tsquam5wd2peugxnusov.jpg');
